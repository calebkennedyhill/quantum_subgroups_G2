...
with structure constants found on the author's GitHub.
...
\begin{definition}
    ...
    \begin{equation*}\tag{Loop}
        \skein{loop}{0.1} = \delta = q^{10} + q^{8} + q^{2} + 1 + q^{-2} + q^{-8} + q^{-10}
    \end{equation*}
...
\[
    F_k\left( \skein{swap_LHS}{0.15} \right) = \omega F_k\left( \skein{swap_RHS}{0.15} \right)
\]
...
\[
F_k\left( \skein{dec_trigon_LHS}{0.1} \right)= 
        t_1 F_k\left( \skein{trivalent}{0.1} \right) 
        + t_2 F_k\left( \skein{triv_rightUp}{0.1} \right)
\]
for $t_1$ and $t_2$.
